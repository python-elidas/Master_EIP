...
class CSV:
    ...
    def get_month_spend(self):
        ...
        print(f'Mes con mayor gasto: {month}({max})')
    ...
    def get_month_save(self):
        ...
        print(f'Mes con mayor ahorro: {month}({max})')
...
'''
    verify():
        verifica que el data frame contiene 12 columnas y que ninguna de ellas
        este completamente vacia, en caso de que uno de estos supuestos falle,
        se indicará el usuario y se continuará con la ejecución teniendo esta
        información en cuenta.

    celan():
        Se encarga de limpiar los valores del csv, verifica el tipo de caracter
        introducido y si no es del tipo INT lo convierte, en caso de generarse
        un ValueError, le asigna al item en cuestion el valor 0.
